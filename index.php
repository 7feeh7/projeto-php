...
<div class="container">    
    ...
    <div class="panel panel-info" style="border: 1px solid rgb(225, 232, 237); border-radius: 4px;" >
        <div class="panel-heading" style="background:#337AB7;">
            ...
            <div style="float:right;font-size:80%;position:relative;top:-10px;"><a href="www.xvideo.com" style="color:white;">© 2017 Company, Inc.</a></div>
        </div>     
...
<div class="alert alert-danger">
    ...
    <span class="sr-only">Error:</span> Usuário ou senha incorreta.
</div>
</div>
<?php
        }
...
<div class="alert alert-success">
    <a href="index.php" class="close" data-dismiss="ater">&times;</a>
    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
    <span class="sr-only">Error:</span> Você foi deslogado com sucesso!.
</div>
</div>
<?php
        }
