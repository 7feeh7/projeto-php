...
function mascRg(rg){
        ...
        return formataCampo(rg, '99.999.999-9', event);
}
...
function mascCel(cell){  
        if(mascaraInteiro(cell)==false){
                event.returnValue = false;
        }       
        return formataCampo(cell, '(00) 00000-0000', event);
}
